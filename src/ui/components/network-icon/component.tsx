...
// espo's explorer Bitcoin roundel, recolored per network (borrowed from b8)
const CIRCLE_PATH =
...
const NetworkIcon: FC<Props> = ({ network, size = 24 }) => {
  const fill = networkInfo(network).color;
  return (
    <svg
